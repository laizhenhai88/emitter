...
function Emitter(opts) {
    ...
    opts = opts || { host: '127.0.0.1', port: 6379 };

    this.redis = client(opts.port, opts.host);
    this.subClient = client(opts.port, opts.host, { return_buffers: true });
...
Emitter.prototype.onmessage = function (channel, msg) {
